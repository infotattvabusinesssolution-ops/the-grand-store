...
export default function AuctionLotCard({ lot, endTime, now, saved, onSave, onBid }) {
  ...
  return (
    <article className="bg-[#111] border border-white/[0.05] rounded-xl overflow-hidden flex flex-col justify-between hover:border-[var(--color-gold)]/50 transition-colors duration-300 shadow-xl group">
      <div>
